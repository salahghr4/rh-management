  ...
  return (
    <div className=" h-screen flex  ">
            ...
            >
              <div className="flex flex-col items-center gap-2 text-center mb-8">
                ...
                <p className="text-balance text-sm ">
                  Entrez votre e-mail ci-dessous pour vous connecter à votre
                  compte
                </p>
                <InputError message={errors.loginError} className="mt-2" />
              </div>
              <div>
      ...
      <div className=" flex-1 hidden lg:block">
        {/* {children} */}
        <img src={img} alt="image" className="w-full h-screen brightness-70" />
      </div>
    </div>
  );
}
