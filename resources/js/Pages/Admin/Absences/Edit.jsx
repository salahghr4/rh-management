...
export default function Edit({ auth, absence, employes }) {
  const [formData, setFormData] = useState({
    date_absence: absence.date_absence || "",
    type: absence.type || "maladie",
    employe_id: absence.employe_id || "",
    justificatif: absence.justificatif || "non",
  });

  const handleSubmit = (e) => {
    e.preventDefault();
    router.put(route("admin.absences.update", absence.id), formData, {
      onSuccess: () => {
        setFormData({
          date_absence: "",
          type: "maladie",
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="w-full">
                    ...
                    <DatePicker
                      ...
                      defaultValue={dayjs(absence.date_absence, "YYYY-MM-DD")}
                    />
                    {errors.date_absence && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        defaultValue={absence.employe_id}
                      />
                      {errors.employe_id && (
                        <p className="text-red-500 text-sm mt-1">
                          {errors.employe_id}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      defaultValue={absence.justificatif}
                    />
                    {errors.justificatif && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.justificatif}
